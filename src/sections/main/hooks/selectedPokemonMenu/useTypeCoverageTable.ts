...
import { getTypeEffectiveness, getTypeInmunities, getTypeResistances } from "../../../../globalHelpers/pokemonTypes/typeInfo";
...
export const useTypeCoverageTable = () => {
    ...
    const getPokemonNonCoveredTypes = (): PokemonType[] => {
        ...
        const resultado = resistedTypes.filter(firstFilter =>
            ...
            === move_list.filter(move => move!.move_type !== MoveType.STATUS).length);
